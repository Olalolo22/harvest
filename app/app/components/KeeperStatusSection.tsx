...
const SETTLED_CYCLES: SettledCycle[] = [
  {
    ...
    settledAt: "Sep 12, 2026 · 16:00 EST",
    txHash: "4iGLKidV77gMkrAV6dbNZcUfkCEunNyiNcpwLTxjX4qaEWf2iHzPMd4rdq8nLdn6EiD8bfwDE174FuZfwrU81e2C",
  ...
  },
  {
    ...
    settlePrice: "$229.40",
    outcome: "OTM",
    premiumYield: "+5.2% APY",
    principalReturned: "100% xAAPL principal returned",
    settledAt: "Sep 05, 2026 · 16:00 EST",
    txHash: "3xP2mQvL88hNksBw7ebMZcUfkCEunNyiNcpwLTxjX4qaEWf2iHzPMd4rdq8nLdn6EiD8bfwDE174FuZfwrU81e2C",
    keeperInstruction: "settle_otm",
  },
  {
    cycleNumber: 10,
    ...
    settlePrice: "$261.20",
    outcome: "ITM",
    premiumYield: "+12.1% APY",
    principalReturned: "Exercised at strike ($255.00) in USDC via Jupiter",
    settledAt: "Aug 29, 2026 · 16:00 EST",
    txHash: "7vK1bNxM99jPkqCv8fcNZcUfkCEunNyiNcpwLTxjX4qaEWf2iHzPMd4rdq8nLdn6EiD8bfwDE174FuZfwrU81e2C",
    keeperInstruction: "settle_itm",
  },
  {
    cycleNumber: 9,
    vaultSymbol: "xNVDA",
